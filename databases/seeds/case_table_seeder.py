...
class CaseTableSeeder(Seeder):
    def run(self):
        ...
        Case.create({
            ...
            "case_type": "Mid",
            "case_price": 129,
            "case_img": "https://i.imgur.com/XFyL0aj.jpg",
        })

        Case.create({
            "case_name": "Lian Li O11 Dynamic (Silver)",
            "case_type": "Mid",
            "case_price": 129,
            "case_img": "https://i.imgur.com/liS7M61.jpg",
        })

        Case.create({
            "case_name": "Lian Li O11 Dynamic Mini (Black)",
            "case_type": "Mid",
            "case_price": 129,
            "case_img": "https://i.imgur.com/UDsiDdp.jpg",
        })

        Case.create({
            "case_name": "Lian Li O11 Dynamic Mini (Silver)",
            "case_type": "Mid",
            "case_price": 129,
